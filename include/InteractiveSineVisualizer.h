...
namespace visualizer {
	...
	private:
		/**
		* This method fills the buffer with the same sine wave for all the samples and
		* then initializes the fft with the sample count. Followed by setting the fft
		* data with the data from the buffer.
		* @param sample_offset The time offset of the sample (not used because creating
		*					   my own sample aka sine, needed for Callback).
